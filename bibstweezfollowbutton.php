<?php
/*
Plugin Name: Bibs TweezFollow Button - Twitter Follow Button
Plugin URI: http://www.blogging-inside.de/
Description: Bibs TweezFollow Button adds the official Twitter Follow Button to your WordPress Blog to increase engagement and create a lasting connection with your Blog Readers. You can use multible Widgets with different Settings or Shortcodes like [tfb username='yourusername' count='true' lang='en' theme='dark'] or [tfb username='yourusername' count='true' lang='en' theme='light']
...
class TweezFollow_Button_Widget extends WP_Widget
{
	function TweezFollow_Button_Widget()
	{
        ...
        parent::WP_Widget(false, $name = 'BibsTweezFollow');
    }
	...
	function widget($args, $instance)
	{
		...
		// Echo output
		echo "<div style='padding:$padding'>";
		echo $output;
		echo "</div>";
		echo $after_widget;
    }
	...
	{
		// Defaults
		$instance = wp_parse_args( (array) $instance, array('username' => 'blogginginside', 'show_count' => 'true', 'button' => 'white', 'text_color' => '000000', 'link_color' => '186487', 'language' => 'en', 'width' => '300px', 'align' => 'left', 'padding' => '8px' ));
